...
<section class="wrapperFull nav">
	...
	<main class="body browsePage">
		...
		<table class="table table-hover">
        					...
        					<tbody>
					            <tr>
					                <td><a href="clientbookview.html?id=<%= browse.getLong("accNum") %>"><%= browse.getLong("accNum") %></a></td>
					                <td><a href="clientbookview.html?id=<%= browse.getLong("accNum") %>"><%= browse.getString("class") %></a></td>
					                <td><a href="clientbookview.html?id=<%= browse.getLong("accNum") %>"><%= browse.getString("bookTitle") %></a></td>
					                <td><a href="clientbookview.html?id=<%= browse.getLong("accNum") %>"><%= browse.getString("author") %></a></td>
