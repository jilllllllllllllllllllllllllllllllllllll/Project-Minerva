		...
		<div class="divWrapper">
			<div class="left block">
				<div class="formContainer">
					...
					<form method="post" action="bookupdate.html">
						...
						<div class="author">
							...
							<input type="text" placeholder="Class" name="bookClass" value="${book.bookClass}"> 
						</div>
						<div class="edition">
						...
						<div class="edition">
							...
							<input type="text" placeholder="Genre" name="genre" value="${book.genre}">
						</div>
